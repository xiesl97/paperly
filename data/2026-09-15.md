...
### [3] [CHEX-MATE: X-ray surface brightness discontinuities across a representative cluster sample](https://arxiv.org/abs/2609.13610)
...
### [4] [Field-Level Baryon Acoustic Oscillation Reconstruction of the DESI DR1 Luminous Red Galaxies with Linear Field Transformer (LiFT)](https://arxiv.org/abs/2609.14862)
...
### [5] [2+1 is not 3: Angular bispectrum and Super-Sample Covariance on the light cone](https://arxiv.org/abs/2609.15385)
...
### [6] [Field-Level Baryon Acoustic Oscillation Reconstruction of the DESI DR1 Luminous Red Galaxies with Linear Field Transformer (LiFT)](https://arxiv.org/abs/2609.14862)
*Liam Parker,Uroš Seljak,Adrian E. Bayer,Richard Feder,David Valcin*
...
### [7] [Gravitational-Wave Image Multiplicity as a Topological Probe of Dark-Matter Core Collapse](https://arxiv.org/abs/2609.15462)
...
### [8] [Anisotropic redshift distributions in photometric galaxy clustering and their cosmological impact](https://arxiv.org/abs/2609.15542)
...
### [9] [The Loud Tail of the Supermassive Black Hole Binary Population: Multimessenger Candidates and Prospects for SKAO](https://arxiv.org/abs/2609.13363)
*Juhan Raidal,Ville Vaskonen,Juan Urrutia,Hardi Veermäe*
...
### [10] [Anisotropic redshift distributions in photometric galaxy clustering and their cosmological impact](https://arxiv.org/abs/2609.15542)
*Zekang Zhang,Yunhe Wang,Daniel Gruen,Hui Kong,Luca Tortorelli,Silvan Fischbacher,Ziang Yan*
...
### [11] [Using the Circumgalactic Medium of Dwarf Galaxies as a Calorimetric Dark Matter Detector](https://arxiv.org/abs/2609.15748)
...
### [12] [Mapping parameters of idealised hydrodynamic galaxy simulations to bar properties: a case study with the RAMSES code](https://arxiv.org/abs/2609.13404)
...
### [13] [The New Dark Matter Density Profile from JWST JADES Galaxies](https://arxiv.org/abs/2609.14071)
...
### [14] [Decoding RR Lyrae light curves with deep learning for accurate absolute magnitude estimation](https://arxiv.org/abs/2609.14342)
...
### [15] [The Connection between Halo Assembly History and the Stellar Distribution I: The Central Stellar Mass - Richness Plane](https://arxiv.org/abs/2609.14488)
...
### [16] [Decoding RR Lyrae light curves with deep learning for accurate absolute magnitude estimation](https://arxiv.org/abs/2609.14342)
*Shunxuan He,Huiwen Wu,Yang Huang,Deyi Zhang,Guirong Xue,Jifeng Liu,Xiaodian Chen,Xinyu Qi,Xiaoyu Tang*
...
### [17] [Tracing Stellar Populations through the Mg-Al Anti-Correlation in Gaia-ESO Globular Clusters](https://arxiv.org/abs/2609.14901)
...
### [18] [Nexus-CDM: Isolated Galaxy Simulations with Cosmologically Evolving Dark-Matter Halos I. Method and Validation](https://arxiv.org/abs/2609.15002)
...
### [19] [The Multiphase CGM in the Epoch of Reionization: CII and CIV absorbers around [OIII] Emitters](https://arxiv.org/abs/2609.15547)
...
### [20] [Chemo-dynamical Analysis of a CNO-Enhanced Ultra Metal-poor Star ($\rm[Fe/H] < -4$): Insights into Early Enrichment by Faint Population III Supernova](https://arxiv.org/abs/2609.13373)
...
### [21] [Constraining the Delay Time Distribution of the r- and s-Process from Stellar Ages at Solar Metallicity](https://arxiv.org/abs/2609.15621)
...
### [22] [Decoding RR Lyrae light curves with deep learning for accurate absolute magnitude estimation](https://arxiv.org/abs/2609.14342)
*Shunxuan He,Huiwen Wu,Yang Huang,Deyi Zhang,Guirong Xue,Jifeng Liu,Xiaodian Chen,Xinyu Qi,Xiaoyu Tang*
...
### [24] [Tracing Stellar Populations through the Mg-Al Anti-Correlation in Gaia-ESO Globular Clusters](https://arxiv.org/abs/2609.14901)
*H. Sinclair-Wentworth,C. C. Worley,P. Jofre,J. Schiappacasse-Ulloa,L. Magrini*
...
### [25] [Constraining the Delay Time Distribution of the r- and s-Process from Stellar Ages at Solar Metallicity](https://arxiv.org/abs/2609.15621)
*Meng Zhang,Hans-Walter Rix*
...
### [26] [The Galactic Black Hole mass distribution](https://arxiv.org/abs/2609.14154)
...
### [27] [Measurement of Cosmic-Ray Density in the Spiral Arms toward Galactic Anticenter](https://arxiv.org/abs/2609.14955)
...
### [28] [Optical spectroscopy of the VHE flat-spectrum radio quasar PKS 0903-57](https://arxiv.org/abs/2609.14999)
...
### [29] [Physics-Informed Neural Networks and Data-Driven Models for GRB X-ray Light-Curve Gap Reconstruction](https://arxiv.org/abs/2609.15261)
...
### [30] [Compelling evidence of a link between the lags of the quasi-periodic oscillations and the radio jet in the black-hole X-ray binary GRS 1915+105](https://arxiv.org/abs/2609.15672)
...
### [31] [Modeling Gamma-Ray Bursts Using CRISP](https://arxiv.org/abs/2609.15761)
...
### [32] [Impact of uncertainties on the cosmic optical and infrared backgrounds on the propagation of astroparticles](https://arxiv.org/abs/2609.15896)
...
### [33] [NICER neutron stars with dark energy and dark matter: effects on the inferred equation of state](https://arxiv.org/abs/2609.14494)
...
### [34] [Optical spectroscopy of the VHE flat-spectrum radio quasar PKS 0903-57](https://arxiv.org/abs/2609.14999)
*E. Kasai,P. Goldoni,C. Boisson,S. Pita,W. Max-Moerbeck,F. D'Ammando,B. Rajput,M. Backes*
...
### [35] [Physics-Informed Neural Networks and Data-Driven Models for GRB X-ray Light-Curve Gap Reconstruction](https://arxiv.org/abs/2609.15261)
*Ayush Garg,Ritik Kumar,Maria G. Dainotti,Vipul Sharma,Amit Shukla,Dieter H. Hartmann*
...
### [36] [Impact of uncertainties on the cosmic optical and infrared backgrounds on the propagation of astroparticles](https://arxiv.org/abs/2609.15896)
*Lucas Gréaux,Antonio Condorelli,Leonel Morejon,Karl-Heinz Kampert,Jonathan Biteau*
...
### [37] [Can Isotropic Thermal Conduction Heat One of the Hottest Cool Cores?](https://arxiv.org/abs/2609.15962)
...
### [38] [Can Isotropic Thermal Conduction Heat One of the Hottest Cool Cores?](https://arxiv.org/abs/2609.15962)
*Samik Mitra,Ramananda Santra,Norbert Werner*
...
### [39] [Astrophysics in the Era of Artificial Intelligence powered by Large Language Models](https://arxiv.org/abs/2609.13301)
*A. R. Rao*
...
### [40] [FOSSIL: Thermo-mechanical architecture](https://arxiv.org/abs/2609.15165)
...
### [41] [Astrophysics in the Era of Artificial Intelligence powered by Large Language Models](https://arxiv.org/abs/2609.13301)
*A. R. Rao*
...
### [42] [FOSSIL: Thermo-mechanical architecture](https://arxiv.org/abs/2609.15165)
*Valentin Sauvage,Clémence de Jabrun,Sylvain Martin,Bruno Maffei,Nabila Aghanim,Anaïs Besnard,Bruno Borgo,Ivan Charles,Xavier Coulon,Sandrine Couturier,Francesco Cuttaia,Jean-Marc Duval,Morgane Loquet Le Gall,Giorgio Savini,Luca Terenzi,Berend Winter*
...
### [43] [Sinking Silicates I: Characterizing the benchmark system containing the T0 brown dwarf CWISE J210640.16+250729.0 using JWST](https://arxiv.org/abs/2609.13433)
...
### [44] [MINCE IV. A detailed analysis of 37 metal-poor and subsolar metallicity stars](https://arxiv.org/abs/2609.15386)
...
### [45] [Stellar activity in a post-merger Giant star](https://arxiv.org/abs/2609.15652)
...
### [46] [The JWST Proto-PAH Project: Detection of the methyl radical CH$_{3}$ in the highly evolved C-rich object SMP LMC 011](https://arxiv.org/abs/2609.15905)
