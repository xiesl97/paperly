...
- [astro-ph.EP](#astro-ph.EP) [Total: 26]
- [astro-ph.GA](#astro-ph.GA) [Total: 50]
- [astro-ph.HE](#astro-ph.HE) [Total: 44]
- [astro-ph.IM](#astro-ph.IM) [Total: 22]
- [astro-ph.SR](#astro-ph.SR) [Total: 32]
...
### [19] [Accurate Galaxy Cluster Shear and Mass Calibration for LSST with AnaCal](https://arxiv.org/abs/2606.21141)
*Conghao Zhou,Xiangchong Li,Hao-Yi Wu,Anja von der Linden,Tesla Jeltema,Tae-hyeon Shin,Simon Birrer,Tomomi Sunayama,Shenming Fu,Prakruth Adari,Lucie Baumont,Surhud More,Anthony Englert,Miranda Gorsuch,Andrés A. Plazas Malagón*
...
### [20] [A cross-calibration approach for polarisation-sensitive detectors in CMB experiments: application to LiteBIRD's polarisation angle calibration](https://arxiv.org/abs/2606.23207)
...
### [21] [Wedge-avoidance Fisher Forecasts for Primordial Non-Gaussianity from Dark-Ages 21-cm Power Spectrum and Bispectrum](https://arxiv.org/abs/2606.23314)
...
### [22] [Field-level weak lensing cosmology with $<100$ simulations using multifidelity simulation-based inference](https://arxiv.org/abs/2606.23346)
...
### [23] [DSWIM:Efficient and Stable Deterministic Computation of Warm Inflation Perturbations](https://arxiv.org/abs/2606.23518)
*Umang Kumar*
...
### [24] [Unifying the Dark Sector with the New Generalized Chaplygin Gas: Observational Constraints](https://arxiv.org/abs/2606.23563)
...
### [25] [Revisiting the 'Lensing is Low' Problem with UNIONS](https://arxiv.org/abs/2606.23651)
...
### [26] [A cross-calibration approach for polarisation-sensitive detectors in CMB experiments: application to LiteBIRD's polarisation angle calibration](https://arxiv.org/abs/2606.23207)
*A. Novelli,F. Piacentini,S. Micheli,E. Allys,A. Anand,J. Aumont,A. J. Banday,R. B. Barreiro,N. Bartolo,S. Basak,A. Basyrov,A. Besnard,D. Blinov,M. Bortolami,T. Brinckmann,F. Cacciotti,E. Calabrese,P. Campeti,A. Carones,F. Carralot,F. J. Casas,J. Chandran,K. Cheung,M. Citran,L. Clermont,F. Columbro,A. Coppolecchia,F. Cuttaia,P. de Bernardis,T. de Haan,E. de la Hoz,M. De Lucia,P. Diego-Palazuelos,H. K. Eriksen,F. Finelli,C. Franceschet,U. Fuskeland,G. Galloni,M. Galloway,M. Gerbino,M. Gervasi,R. T. Génova-Santos,T. Ghigna,S. Giardiello,C. Gimeno-Amo,A. Gruppuso,M. Hazumi,S. Henrot-Versillé,L. T. Hergt,E. Hivon,H. Ishino,K. Kohri,L. Lamagna,M. Lattanzi,C. Leloup,F. Levrier,A. I. Lonappan,M. López-Caniego,G. Luzzi,J. Macias-Perez,V. Maranchery,E. Martínez-González,S. Masi,S. Matarrese,T. Matsumura,M. Migliaccio,M. Monelli,G. Morgante,L. Mousset,R. Nagata,T. Namikawa,P. Natoli,F. Noviello,L. Pagano,A. Paiella,D. Paoletti,G. Pascual-Cisneros,G. Patanchon,G. Piccirilli,M. Pinchera,G. Polenta,L. Porcelli,M. Remazeilles,A. Ritacco,M. Ruiz-Granda,Y. Sakurai,L. Salvati,J. Sanghavi,V. Sauvage,D. Scott,M. Shiraishi,G. Signorelli,R. M. Sullivan,Y. Takase,L. Terenzi,M. Tomasi,M. Tristram,L. Vacher,B. van Tent,P. Vielva,S. Vinzl,I. K. Wehus,G. Weymann-Despres,E. J. Wollack,M. Zannoni*
...
### [27] [Wave-optics imprints of dark matter subhalos on strongly lensed gravitational waves. II. Saddle images and detectability](https://arxiv.org/abs/2606.21519)
*Shin'ichiro Ando*
...
### [28] [The local ultraviolet signature of Type Ia supernova environments from HST and MUSE](https://arxiv.org/abs/2606.22173)
*Lluís Galbany,Cullen Abelson,Alaa Alburai,Joseph P Anderson,Yago Ascasibar,Chris Ashall,Carles Badenes,Chris Burns,Èlia Diéguez Gurnés,Albert García Soto,Claudia P. Gutiérrez,Eric Y. Hsiao,Hanindyo Kuncarayakti,Andrew J. Levan,Jospeh Lyman,Mark M. Phillips,Sebastian F. Sánchez,Ramon Sanfeliu,Maximilian Stritzinger,Danny Steeghs*
...
### [29] [Fast Radio Burst Cosmology: Hubble Tension and Dark Energy](https://arxiv.org/abs/2606.22390)
*Fayin Wang,Xuandong Jia,Daohong Gao,Zigao Dai*
...
### [30] [Euclid: Quick Data Release (Q1) -- LensMC shear measurement catalogue for cluster lensing science](https://arxiv.org/abs/2606.20829)
*G. Congedo,M. Sereno,H. Miyatake,S. Guerrini,M. Kilbinger,M. Radovich,H. Jansen,F. Kleinebreil,T. Schrabback,A. N. Taylor,B. Altieri,L. Amendola,S. Andreon,N. Auricchio,C. Baccigalupi,M. Baldi,S. Bardelli,P. Battaglia,A. Biviano,R. P. Blake,E. Branchini,M. Brescia,S. Camera,V. Capobianco,C. Carbone,V. F. Cardone,J. Carretero,M. Castellano,G. Castignani,S. Cavuoti,A. Cimatti,C. Colodro-Conde,L. Conversi,Y. Copin,F. Courbin,H. M. Courtois,M. Cropper,H. Degaudenzi,G. De Lucia,C. Dolding,H. Dole,F. Dubath,X. Dupac,M. Farina,R. Farinelli,S. Ferriol,F. Finelli,P. Fosalba,S. Fotopoulou,M. Frailis,M. Fumana,L. Gabarra,S. Galeotta,K. George,B. Gillis,C. Giocoli,J. Gracia-Carpio,A. Grazian,F. Grupp,S. Hemmati,M. S. Holliman,W. Holmes,I. M. Hook,F. Hormuth,A. Hornstrup,K. Jahnke,M. Jhabvala,S. Kermiche,B. Kubik,M. Kümmel,M. Kunz,H. Kurki-Suonio,A. M. C. Le Brun,S. Ligori,P. B. Lilje,V. Lindholm,I. Lloro,M. Magliocchetti,G. Mainetti,O. Mansutti,O. Marggraf,M. Martinelli,N. Martinet,F. Marulli,R. J. Massey,E. Medinaceli,M. Meneghetti,E. Merlin,G. Meylan,A. Mora,M. Moresco,C. Moretti,L. Moscardini,E. Munari,R. Nakajima,C. Neissner,R. C. Nichol,S. -M. Niemi,C. Padilla,S. Paltani,F. Pasian,W. J. Percival,V. Pettorino,A. Pezzotta,S. Pires,G. Polenta,M. Poncet,L. A. Popa,F. Raison,A. Renzi,J. Rhodes,G. Riccio,E. Romelli,M. Roncarelli,C. Rosset,B. Rusholme,R. Saglia,Z. Sakr,A. G. Sánchez,D. Sapone,M. Schirmer,P. Schneider,A. Secroun,E. Sihvola,C. Sirignano,G. Sirri,L. Stanco,P. Tallada-Crespí,I. Tereno,S. Toft,R. Toledo-Moreo,F. Torradeflot,I. Tutusaus,E. A. Valentijn,J. Valiviita,T. Vassallo,Y. Wang,J. Weller,A. Zacchei,G. Zamorani,F. M. Zerbi,E. Zucca,T. Castro*
...
### [31] [Loss-Cone-Limited Dark Matter Accretion onto Early Black Hole Seeds](https://arxiv.org/abs/2606.20964)
*Brian Zhang,Grant J. Mathews*
...
### [32] [Dark Energy in the DESI Era: A Brief Review of Evidence, Beyond-$Λ$CDM Interpretations, and Tensions](https://arxiv.org/abs/2606.21826)
*Tian-Nuo Li,Guo-Hong Du,Hao Wang,Yun-He Li,Jing-Fei Zhang,Xin Zhang*
...
### [33] [Optimization of Tessellation-based Statistics: Void Statistics](https://arxiv.org/abs/2606.21864)
*Yu Liu,Cheng Zhao,Yu Yu,Zhejie Ding,Jean-Paul Kneib*
...
### [34] [The local ultraviolet signature of Type Ia supernova environments from HST and MUSE](https://arxiv.org/abs/2606.22173)
*Lluís Galbany,Cullen Abelson,Alaa Alburai,Joseph P Anderson,Yago Ascasibar,Chris Ashall,Carles Badenes,Chris Burns,Èlia Diéguez Gurnés,Albert García Soto,Claudia P. Gutiérrez,Eric Y. Hsiao,Hanindyo Kuncarayakti,Andrew J. Levan,Jospeh Lyman,Mark M. Phillips,Sebastian F. Sánchez,Ramon Sanfeliu,Maximilian Stritzinger,Danny Steeghs*
...
### [35] [Tracing Large-scale Structure with the MeerKLASS On-the-Fly Survey: Angular Clustering of Radio Sources at 816 MHz](https://arxiv.org/abs/2606.22432)
*Sourabh Paul,Suman Chatterjee,Keith Grainge,Laura Wolz,Aishrila Mazumder,Steven Cunnington,Sarvesh Mangla,Joseph J. Mohr,Mario G. Santos,Oleg Smirnov,Cyril Tasse*
...
### [36] [Understanding the non-Gaussian nature of Galactic foreground emissions towards small scales](https://arxiv.org/abs/2606.22596)
*Fazlu Rahman,Pravabati Chingangbam,Kevin Huffenberger,Tuhin Ghosh,Dmitri Pogosyan,Tarun Souradeep,Changbom Park*
...
### [37] [Dynamical Tides during High-Eccentricity Migration produces the Hot Jupiter Pile-up, Neptune Ridge, and Neptune Desert](https://arxiv.org/abs/2606.20789)
...
### [38] [Planet--Planet Secular Migration Predicts a Stellar Obliquity--Period Anti-Correlation](https://arxiv.org/abs/2606.20803)
...
### [39] [Implications of self-consistent H$_2$O ice optical constants on radiative transfer models of disks](https://arxiv.org/abs/2606.21529)
...
### [40] [Environmental interactions in Class II systems and their impact on the disk-planet architecture](https://arxiv.org/abs/2606.21533)
...
### [41] [Investigation of Split Comet 240P/NEAT](https://arxiv.org/abs/2606.21609)
...
### [42] [The GAPS Programme at TNG LXXIV. A reanalysis of the planetary systems TOI-1272 and TOI-1694 with HARPS-N and retraction of the planetary interpretation of TOI-1272 c](https://arxiv.org/abs/2606.21625)
...
### [43] [ARCO-Mars: A Unified Cloud-Optimized Archive of Mars Atmosphere Reanalysis](https://arxiv.org/abs/2606.21701)
*Ananyo Bhattacharya*
...
### [44] [Radiatively Controlled Thermal Stability of High-Altitude Clouds in Exoplanetary Atmospheres](https://arxiv.org/abs/2606.21770)
...
### [45] [The panchromatic JWST dayside spectrum of WASP-121 b reveals a refractory-rich formation](https://arxiv.org/abs/2606.21855)
...
### [46] [Autonomous Orbit Determination Analysis of a Conceptual Cislunar Navigation Constellation based on Inter-Satellite Range Measurement](https://arxiv.org/abs/2606.22362)
...
### [47] [Magnetic field strengths of hot giant exoplanets consistent with Solar System values](https://arxiv.org/abs/2606.22455)
...
### [48] [Parameterizing slantwise convection in icy moon oceans](https://arxiv.org/abs/2606.22547)
...
### [49] [Characterising transiting exoplanets at long orbital period: lessons learned for PLATO from 10 years of monitoring the HIP41378 system](https://arxiv.org/abs/2606.22996)
...
### [50] [A decade of monitoring the HIP 41378's planetary system](https://arxiv.org/abs/2606.23103)
...
### [51] [Resonance and Stochastic Dynamics of Interplanetary Dust](https://arxiv.org/abs/2606.23133)
...
### [52] [Thermal and rotational effects of giant impacts during terrestrial planet accretion](https://arxiv.org/abs/2606.23168)
...
### [53] [Parametrizing the projected wind fields of ultra-hot Jupiters in thermal emission: an application to GCM spectra of WASP-76b](https://arxiv.org/abs/2606.23209)
...
### [54] [The Barnard's Star Planetary System: Stability, Composition, and Evolution of Four Sub-Earth Exoplanets](https://arxiv.org/abs/2606.23310)
...
### [55] [A Multiband Study of the HR 4796A Disk in the Optical Using MagAO-X](https://arxiv.org/abs/2606.23480)
...
### [56] [Energy-Limited Radiolytic Habitability in the Shallow Martian Subsurface: Implications for ExoMars Rosalind Franklin and Tianwen-3](https://arxiv.org/abs/2606.23483)
*Dimitra Atri*
...
### [57] [ARCO-Mars: A Unified Cloud-Optimized Archive of Mars Atmosphere Reanalysis](https://arxiv.org/abs/2606.21701)
*Ananyo Bhattacharya*
...
### [58] [Observing a 542-day transiting giant with large TTVs: The 2025 transit of HIP 41378 f and new constraints on the outer system](https://arxiv.org/abs/2606.23551)
...
### [59] [Autonomous Orbit Determination Analysis of a Conceptual Cislunar Navigation Constellation based on Inter-Satellite Range Measurement](https://arxiv.org/abs/2606.22362)
*Haohan Li,Yuxuan Miao,Xiyun Hou,Bosheng Li,Jinjun Zheng,Hao Yu,Kanglian Zhao,Huan Yan*
...
### [60] [Characterising transiting exoplanets at long orbital period: lessons learned for PLATO from 10 years of monitoring the HIP41378 system](https://arxiv.org/abs/2606.22996)
*Alexandre Santerne,Salomé Grouffal,Stéphane Udry*
...
### [61] [Environmental interactions in Class II systems and their impact on the disk-planet architecture](https://arxiv.org/abs/2606.21533)
*Pedro P. Poblete,Nicolás Cuello,Tim D. Pearce,Antoine Alaguero,Josh Calcino,Daniel J. Price,Michael Kuffmeier*
...
### [62] [Magnetic field strengths of hot giant exoplanets consistent with Solar System values](https://arxiv.org/abs/2606.22455)
*Julia V. Seidel,Vivien Parmentier,Bibiana Prinoth,Thea Hood,Nishil Mehta,Valentin De Lia,Konstantin Batygin,Tristan Guillot,Ragnar Van den Broeck,Hayley Beltz,Brian Thorsbro,Florian Debras,Daniel D. B. Koll,Thaddeus D. Komacek,Emily Rauscher,Lorenzo Pino,Matteo Brogi,Joost P. Wardenier,Jacob L. Bean,Björn Benneke,Jean-Michel L. B. Désert,Pablo Drake,Siddharth Gandhi,Mark Hammond,David Kasper,Michael R. Line,Elspeth K. H. Lee,Stefan Pelletier,Andreas Seifahrt,Adrien Simonnin,Peter C. B. Smith,Kevin B. Stevenson*
...
### [63] [Gas-induced perturbations on the gravitational wave in-spiral of live post-Newtonian LISA massive black hole binaries: 0.1 disk aspect ratio](https://arxiv.org/abs/2606.20787)
...
### [64] [The explosive growth of the Messier 74 galaxy. A galaxy doubling its size in less than a Gigayear](https://arxiv.org/abs/2606.20793)
...
### [65] [No hidden monsters: Probing recently-quenched galaxies for obscured AGN with JWST-PRIMER MIRI and NIRCam](https://arxiv.org/abs/2606.20800)
...
### [67] [LEGGOS II: A Strong Lens Model and Source-Plane Projection of the Clumpy Star-Forming Galaxy SGASJ111020.0+645950.8 at z=2.48](https://arxiv.org/abs/2606.20804)
...
### [69] [Investigating the Spectral Properties of Dual Nuclei in Galaxy Mergers from the GOTHIC survey: Supermassive Black Hole Growth, metal enrichment and Dual AGN](https://arxiv.org/abs/2606.20810)
...
### [70] [LEGGOS I: The JWST LEGGOS Survey -- LEnsing and Galaxy Growth: Observing Substructures -- Unpacks the Nature of Clumpy Star Formation and Quenching in Gravitationally Lensed Galaxies beyond Cosmic Noon](https://arxiv.org/abs/2606.20845)
...
### [71] [Molecular cloud dispersal traced by the ionized carbon 158 micron line](https://arxiv.org/abs/2606.20883)
...
### [72] [Variables in S-PLUS: I. Multiband period-luminosity relations and reddening maps of the Magellanic Clouds using classical Cepheids](https://arxiv.org/abs/2606.20953)
...
### [73] [Globular Clusters in the Time of the JWST. I. Survey Design and First Results on Multiple Populations and Beyond](https://arxiv.org/abs/2606.20979)
...
### [74] [Clumpy Disk, Interloper, or Merger? Nature of a Distant Galaxy Pair at 5 kpc Projected Separation](https://arxiv.org/abs/2606.21007)
...
### [75] [VST-SMASH: VST Survey of Mass Assembly and Structural Hierarchy II. Exploring dwarf galaxies in the vicinity of NGC 5068 and of the two galaxies NGC 5084 and NGC 5087 at the edges of the Virgo Supercluster](https://arxiv.org/abs/2606.21117)
...
### [76] [Star Formation at the Periphery of a Molecular Superbubble: The Case of G12.79+0.43](https://arxiv.org/abs/2606.21160)
...
### [77] [All-sky modeling of Galactic emission at radio and microwave frequencies](https://arxiv.org/abs/2606.21334)
...
### [78] [Extended [CII] gas emission in and around a massive quiescent galaxy at z=7.3](https://arxiv.org/abs/2606.21361)
...
### [79] [X-ray emission maps and scaling relations in IllustrisTNG and MillenniumTNG: Differences between cluster and group regimes](https://arxiv.org/abs/2606.21495)
...
### [80] [Little Red and Blue Dots: AGN-excited narrow lines, Lyman-$α$ emission, and resemblance to standard quasars](https://arxiv.org/abs/2606.21614)
...
### [81] [Resolved Ages and Stellar Metallicities in Progenitors of Milky Way Analogs: A Closer Look at their Star Formation Histories since $z=5$](https://arxiv.org/abs/2606.21651)
...
### [82] [The $M$-$σ$ Relation Has to Break](https://arxiv.org/abs/2606.21656)
...
### [83] [LEGGOS III: Mapping Star Formation and Dust in Gravitationally Lensed Galaxies with $\textit{SUMAC}$, a UMAP and Clustering Framework](https://arxiv.org/abs/2606.20801)
*Alex Ross,Gourav Khullar,Taylor Hutchison,Dylan Berry,Aritra Ghosh,T. Emil Rivera-Thorsen,Guillaume Mahler,Brian Welch,Pedram Abedi,Cole Panzer,Michael Florian,Julissa Sarmiento,the JWST LEGGOS Collaboration*
...
### [84] [A new solution for the mass growth of Black Holes consistent with thermodynamics](https://arxiv.org/abs/2606.21729)
...
### [85] [Reaction Mechanisms and Kinetics of CN and CCH with H2CS: Implications for Interstellar Sulfur Chemistry](https://arxiv.org/abs/2606.21730)
...
### [86] [Euclid Quick Data Release (Q1): The geometry of dark matter halos from extragalactic streams](https://arxiv.org/abs/2606.21774)
...
### [87] [Complex organic molecules in the young hot core RCW 120 S2](https://arxiv.org/abs/2606.21989)
...
### [88] [Measuring Magnetic Field Strengths in Galactic Star-forming Regions via the Zeeman Effect with the SKA](https://arxiv.org/abs/2606.22090)
...
### [89] [Migration Traps as Variability Attractors: Optical/UV Signatures of Embedded Stellar-Mass Black Holes in Active Galactic Nucleus Disks](https://arxiv.org/abs/2606.22559)
...
### [90] [Globular Clusters in the Time of the JWST. I. Survey Design and First Results on Multiple Populations and Beyond](https://arxiv.org/abs/2606.20979)
*A. P. Milone,A. F. Marino,G. Cordoni,E. Dondoglio,M. V. Legnardi,T. Ziliotto,E. Bortolan,F. Muratore,F. D'Antona,A. Renzini,G. Girardi,L. Gorza,A. Mastrobuono-Battisti,C. Ventura,P. Ventura,V. Altomonte,L. Bisigello,Y. Cavecchi,F. Dell'Agli,A. Dotter,E. P. Lagioia,C. Li,S. Lionetto,A. Marchuk,J. Qi,G. Rodrighiero,M. Tailo,H. Wirth*
...
### [91] [On the Tully-Fisher Relation for Active Galaxies -- I: Evidence of Larger Scatter](https://arxiv.org/abs/2606.22575)
...
### [92] [Star Formation at the Periphery of a Molecular Superbubble: The Case of G12.79+0.43](https://arxiv.org/abs/2606.21160)
*Arun Seshadri,Veena V. S.,Sarita Vig,Ashish P John*
...
### [93] [Black Hole Occupation Fraction: Dependence on Black Hole Mass Threshold, Environment, Resolution and Redshift](https://arxiv.org/abs/2606.22758)
...
### [94] [Highly filamentary H{\,\small I} gas in the circumgalactic medium and intragalactic medium around NGC 4631](https://arxiv.org/abs/2606.22764)
...
### [95] [LEGGOS I: The JWST LEGGOS Survey -- LEnsing and Galaxy Growth: Observing Substructures -- Unpacks the Nature of Clumpy Star Formation and Quenching in Gravitationally Lensed Galaxies beyond Cosmic Noon](https://arxiv.org/abs/2606.20845)
*Gourav Khullar,Michael Florian,Matthew B. Bayliss,Taylor A. Hutchison,Brian Welch,Keren Sharon,Jane R. Rigby,Dylan Berry,T. Emil Rivera-Thorsen,Håkon Dahle,Sedona H. Price,Nikko J. Cleri,Julissa Sarmiento,Guillaume Mahler,Michael D. Gladders,Rachel Bezanson,Alex Ross,Pedram Abedi,Rion Oh,John Chisholm,Keunho Kim,Katherine E. Whitaker,Aleena Ebey,Cole Panzer,Jacqueline Antwi-Danso,Catherine Cerny,Suhyeon C. Choe,Juliana S. M. Karp,James W. Kulp,Tim B. Miller,Grace M. Olivier,M. Riley Owens,David J. Setton,Irene Shivaei,Erik Solhaug,Amritaansh Srivastava,Sierra Bet*
...
### [96] [Observations of a Possible Transient Magnetically Arrested Accretion State in a Nearby Quasar: OQ208](https://arxiv.org/abs/2606.22845)
...
### [97] [When bars and spirals conspire: recurrent build-up of the nuclear regions of disc galaxies](https://arxiv.org/abs/2606.23014)
...
### [98] [All-sky modeling of Galactic emission at radio and microwave frequencies](https://arxiv.org/abs/2606.21334)
*Gabriel A. Hoerning,Clive Dickinson,Stuart E. Harper,Roke Cepeda-Arroita,Hans K. Eriksen,Melis O. Irfan,J. Patrick Leahy,Jamie Leech,Michael E. Jones,Timothy J. Pearson,Michael W. Peel,Vasundhara Shaw,Angela C. Taylor,Duncan J. Watts,Ingunn K. Wehus,Gilles Weymann-Despres*
...
### [99] [Complex organic molecules in the young hot core RCW 120 S2](https://arxiv.org/abs/2606.21989)
*M. S. Kirsanova,A. A. Farafontova*
...
### [100] [Cold kinetic theory is not cold fluid theory: A collective mode in self-gravitating spheres](https://arxiv.org/abs/2606.23068)
*Mikael Tacu*
...
### [101] [Little Red and Blue Dots: AGN-excited narrow lines, Lyman-$α$ emission, and resemblance to standard quasars](https://arxiv.org/abs/2606.21614)
*Sophia Geris,Roberto Maiolino,Xihan Ji,Guido Risaliti,Giorgio Lanzuisi,Francesco D'Eugenio,Yuki Isobe,Gareth Jones,Anishya Harshan,Matilde Brazzini,Ignas Juodžbalis,Jan Scholtz,Pierluigi Rinaldi,Hannah Übler,William Baker,Andrew J. Bunker,Marcella Brusa,Stefano Carniani,Stephane Charlot,Mirko Curti,Andrea Comastri,Emma Curtis Lake,Roberto Gilli,Kevin Hainline,Piero Madau,Stefano Marchesi,Giovanni Mazzolari,Lorenzo Napolitano,Eleonora Parlanti,Laura Pentericci,Cristina Ramos Almeida,Brant Robertson,Maddie S. Silcock,Roberta Tripodi,Giacomo Venturi,Cristian Vignali,Fabio Vito,Yongda Zhu*
...
### [102] [RAD@home discovery of a bow-and-arrow radio galaxy tracing a ~560 kpc bow-shock structure in a multi-halo environment](https://arxiv.org/abs/2606.23106)
...
### [103] [Euclid Quick Data Release (Q1): The geometry of dark matter halos from extragalactic streams](https://arxiv.org/abs/2606.21774)
*Euclid Collaboration,N. Starkman,J. Nibauer,S. Pearson,S. Wu,M. Walmsley,L. Necib,J. Bovy,F. R. Marleau,E. Sola,D. Scott,B. Altieri,S. Andreon,N. Auricchio,C. Baccigalupi,M. Baldi,A. Balestra,S. Bardelli,P. Battaglia,A. Biviano,M. Bolzonella,E. Branchini,M. Brescia,J. Brinchmann,S. Camera,V. Capobianco,C. Carbone,J. Carretero,S. Casas,M. Castellano,G. Castignani,S. Cavuoti,K. C. Chambers,A. Cimatti,C. Colodro-Conde,G. Congedo,C. J. Conselice,L. Conversi,Y. Copin,A. Costille,F. Courbin,H. M. Courtois,M. Cropper,H. Degaudenzi,G. De Lucia,H. Dole,F. Dubath,C. A. J. Duncan,X. Dupac,S. Dusini,S. Escoffier,M. Fabricius,M. Farina,R. Farinelli,S. Ferriol,F. Finelli,P. Fosalba,S. Fotopoulou,M. Frailis,E. Franceschi,M. Fumana,L. Gabarra,S. Galeotta,K. George,B. Gillis,C. Giocoli,P. Gómez-Alvarez,J. Gracia-Carpio,A. Grazian,F. Grupp,S. V. H. Haugan,W. Holmes,F. Hormuth,A. Hornstrup,M. Huertas-Company,K. Jahnke,M. Jhabvala,B. Joachimi,S. Kermiche,A. Kiessling,B. Kubik,M. Kümmel,M. Kunz,H. Kurki-Suonio,A. M. C. Le Brun,S. Ligori,P. B. Lilje,V. Lindholm,I. Lloro,M. Magliocchetti,G. Mainetti,O. Mansutti,O. Marggraf,M. Martinelli,N. Martinet,F. Marulli,R. J. Massey,N. Mauri,E. Medinaceli,S. Mei,M. Melchior,M. Meneghetti,E. Merlin,G. Meylan,P. Monaco,A. Mora,M. Moresco,C. Moretti,L. Moscardini,R. Nakajima,C. Neissner,R. C. Nichol,S. -M. Niemi,J. W. Nightingale,C. Padilla,S. Paltani,F. Pasian,K. Pedersen,W. J. Percival,V. Pettorino,A. Pezzotta,S. Pires,G. Polenta,M. Poncet,L. A. Popa,L. Pozzetti,F. Raison,A. Renzi,J. Rhodes,G. Riccio,I. Risso,E. Romelli,M. Roncarelli,C. Rosset,R. Saglia,Z. Sakr,D. Sapone,B. Sartoris,P. Schneider,A. Secroun,E. Sihvola,P. Simon,C. Sirignano,G. Sirri,L. Stanco,P. Tallada-Crespí,A. N. Taylor,I. Tereno,N. Tessore,S. Toft,R. Toledo-Moreo,F. Torradeflot,A. Tsyganov,I. Tutusaus,E. A. Valentijn,J. Valiviita,T. Vassallo,G. Verdoes Kleijn,A. Veropalumbo,Y. Wang,J. Weller,A. Zacchei,G. Zamorani,F. M. Zerbi,E. Zucca,M. Ballardini,E. Bozzo,C. Burigana,R. Cabanac,M. Calabrese,A. Cappi,T. Castro,J. A. Escartin Vigo,J. García-Bellido,J. Macias-Perez,R. Maoli,J. Martín-Fleitas,R. B. Metcalf,M. Pöntinen,V. Scottez,M. Sereno,M. Tenti,M. Tucci,M. Viel,M. Wiesmann,Y. Akrami,I. T. Andika,G. Angora,S. Anselmi,M. Archidiacono,F. Atrio-Barandela,L. Bazzanini,D. Bertacca,M. Bethermin,F. Beutler,A. Blanchard,L. Blot,M. L. Brown,S. Bruton,A. Calabro,B. Camacho Quevedo,F. Caro,C. S. Carvalho,F. Cogato,A. R. Cooray,O. Cucciati,F. De Paolis,G. Desprez,A. Díaz-Sánchez,S. Di Domizio,J. M. Diego,P. -A. Duc,V. Duret,M. Y. Elkhashab,A. Enia,Y. Fang,A. Finoguenov,A. Franco,K. Ganga,T. Gasparetto,R. Gavazzi,E. Gaztanaga,F. Giacomini,F. Gianotti,E. J. Gonzalez,G. Gozaliasl,A. Gruppuso,M. Guidi,C. M. Gutierrez,A. Hall,C. Hernández-Monteagudo,H. Hildebrandt,J. Hjorth,L. K. Hunt,J. J. E. Kajava,Y. Kang,V. Kansal,D. Karagiannis,K. Kiiveri,J. Kim,C. C. Kirkpatrick,S. Kruk,M. Lattanzi,M. Lembo,F. Lepori,G. Leroy,J. Lesgourgues,T. I. Liaudat,S. J. Liu,A. Loureiro,G. Maggio,A. Manjón-García,F. Mannucci,C. J. A. P. Martins,L. Maurin,M. Miluzio,G. Morgante,S. Nadathur,K. Naidoo,A. Navarro-Alsina,S. Nesseris,D. Paoletti,F. Passalacqua,K. Paterson,L. Patrizii,C. Pattison,A. Pisani,D. Potter,G. W. Pratt,S. Quai,M. Radovich,K. Rojas,W. Roster,S. Sacquegna,M. Sahlén,D. B. Sanders,E. Sarpa,A. Schneider,D. Sciotti,E. Sellentin,F. Shankar,J. Stadel,K. Tanidis,F. Tarsitano,G. Testera,R. Teyssier,S. Tosi,A. Troja,M. Urbano,C. Valieri,A. Venhola,D. Vergani,G. Verza,P. Vielzeuf,S. Vinciguerra,N. A. Walton,J. R. Weaver,A. H. Wright*
...
### [104] [Modelling the diffuse continuum emission: the NLS1 Mrk 110](https://arxiv.org/abs/2606.23191)
...
### [105] [Spatially resolved star formation history of Sextans dSph](https://arxiv.org/abs/2606.23216)
*Andrés E. Piatti*
...
### [106] [The hidden variability of the torus in local Active Galactic Nuclei: 20 years of Chandra, XMM-Newton, and NuSTAR observations](https://arxiv.org/abs/2606.23266)
...
### [107] [Gas-induced perturbations on the gravitational wave in-spiral of live post-Newtonian LISA massive black hole binaries: 0.1 disk aspect ratio](https://arxiv.org/abs/2606.20787)
*Mudit Garg,Alessia Franchini,Alessandro Lupi*
...
### [108] [Detection of Variability in Seyfert 2 Galaxies and Measurement of the Optical Scattering Region Size](https://arxiv.org/abs/2606.23564)
...
### [109] [The EDGE-CALIFA Survey: Star Formation Efficiency and Galaxy Quenching across 62 Main Sequence, Green Valley, and Red Galaxies](https://arxiv.org/abs/2606.23649)
...
### [110] [Ram-pressure signatures in the dwarf irregular galaxy SextansB revealed by deep MeerKAT HI observations](https://arxiv.org/abs/2606.23674)
...
### [111] [Little Red Dots on FIRE: Exploring the formation and observational signatures of ultra-compact early galaxies](https://arxiv.org/abs/2606.23683)
...
### [112] [Migration Traps as Variability Attractors: Optical/UV Signatures of Embedded Stellar-Mass Black Holes in Active Galactic Nucleus Disks](https://arxiv.org/abs/2606.22559)
*Jing-Tong Xing,Tong Liu,Mouyuan Sun,Ya-Ping Li,Shuying Zhou,Zhen-Yi Cai,Da-Bin Lin,Jian-Min Wang*
...
### [113] [Old and Bright: The Remarkable Radio Brightening of the Engine-driven SN 2012au Several Years After Explosion Signals the Birth of a PWN](https://arxiv.org/abs/2606.20836)
...
### [114] [Radio Follow Up of a Sub-threshold GRB in the Sky Localization Area of GW241125](https://arxiv.org/abs/2606.20885)
...
### [115] [Little Red Dots as Supermassive Analogs of SS 433](https://arxiv.org/abs/2606.21105)
...
### [116] [XRISM Time-resolved Fe K$α$ Spectroscopy of NGC 4395: Time-variable Inner-disk Emission](https://arxiv.org/abs/2606.21180)
...
### [117] [Probing dipole and quadrupole anisotropy in Gamma-ray bursts from Swift dataset](https://arxiv.org/abs/2606.21182)
...
### [118] [A broadband view of the thermal and non-thermal emission from the embedded massive star cluster RCW 38](https://arxiv.org/abs/2606.21288)
...
### [119] [A New Scaling of Neutron Star Tidal Deformability for Directly Probing the Core Equation of State](https://arxiv.org/abs/2606.21402)
...
### [120] [The Fundamental Planes of Black Hole Activity for High-Synchrotron-Peaked BL Lacertae Objects](https://arxiv.org/abs/2606.21426)
...
### [121] [Subgrid Modelling for Relativistic Magnetohydrodynamics with Machine Learning](https://arxiv.org/abs/2606.21659)
...
### [122] [Getting Tilted: Random Walk of Binary Black Hole Spin-Orbit Alignment in Dense Star Clusters](https://arxiv.org/abs/2606.21691)
...
### [123] [A grid of fast-rotating, chemically-homogeneous, supernova and/or long-GRB progenitors](https://arxiv.org/abs/2606.21824)
...
### [124] [Do Prompt Gamma-ray Burst Fireball Composition Impact on Afterglow Emission? Cases Study for Long GRBs 080916C/090902B and Short GRBs 090510/130603B](https://arxiv.org/abs/2606.21827)
...
### [125] [Intraday Optical Variability of BL Lacertae during its Highly Active 2020-2024 Phase](https://arxiv.org/abs/2606.21936)
...
### [126] [Fast Optical Variability of the TeV Blazar PKS 1725+123 Observed by SVOM-VT and Insights from Multi-wavelength Follow-up Observations](https://arxiv.org/abs/2606.21966)
...
### [127] [Multiwavelength variability of the high-energy neutrino candidate PKS 0735+178 over three decades](https://arxiv.org/abs/2606.22190)
...
### [128] [Crust glass formation reveals the neutron star birth properties in IGR J17480-2446](https://arxiv.org/abs/2606.22227)
...
### [129] [A charming ICECUBE discover?](https://arxiv.org/abs/1911.07240)
...
### [130] [Fast targeted gravitational-wave followup search for compact binary mergers using GSTLAL pipeline](https://arxiv.org/abs/2606.22266)
...
### [131] [EMU discovery of Thunder: a bow-shock PWN powered by PSR J1631-4722 escaping Nimbus SNR (G336.7+0.5)](https://arxiv.org/abs/2606.22354)
...
### [132] [Fermi bubbles detected in $\sim$100 TeV neutrinos](https://arxiv.org/abs/2606.22387)
...
### [133] [Unified Mass-Scaled QPO Signatures of Kerr Sen Black Holes from Stellar Mass to Supermassive Sources](https://arxiv.org/abs/2606.22446)
...
### [134] [Polarization Angle Geodesics in PSRs B1133+16 and B2016+28](https://arxiv.org/abs/2606.22667)
*M. M. McKinnon*
...
### [135] [Finite-volume scheme for first-order viscoresistive relativistic magnetohydrodynamics](https://arxiv.org/abs/2606.22691)
...
### [136] [Testing the Generalization and Domain Stability of Compact Feature Representations for Photometric Supernova Classification](https://arxiv.org/abs/2606.22879)
*Anurag Garg*
...
### [137] [Testing the Generalization and Domain Stability of Compact Feature Representations for Photometric Supernova Classification](https://arxiv.org/abs/2606.22879)
*Anurag Garg*
...
### [138] [Are most detected tidal disruption events partial?](https://arxiv.org/abs/2606.22919)
...
### [139] [UHECR Clustering: Lightest Nuclei from Local Sheet Galaxies](https://arxiv.org/abs/2408.07172)
...
### [140] [On the assessment of the disk truncation and detection of type-II bursts from the accreting millisecond X-ray Pulsar IGR J17062-6143](https://arxiv.org/abs/2606.23156)
...
### [141] [A broadband view of the thermal and non-thermal emission from the embedded massive star cluster RCW 38](https://arxiv.org/abs/2606.21288)
*Giada Peron,Andrea Bracco,Giovanni Morlino,Silvia Mantovanini,Elena Amato,Daniele Galli,Marco Padovani*
...
### [142] [When the black holes align: a subpopulation of aligned massive binary black holes observed via gravitational waves](https://arxiv.org/abs/2606.23305)
...
### [143] [Probing dipole and quadrupole anisotropy in Gamma-ray bursts from Swift dataset](https://arxiv.org/abs/2606.21182)
*Vedant Mokal,Shantanu Desai*
...
### [144] [Galactic Cosmic Ray Transport in the Giant Circumgalactic Medium Halo](https://arxiv.org/abs/2606.23317)
...
### [145] [A grid of fast-rotating, chemically-homogeneous, supernova and/or long-GRB progenitors](https://arxiv.org/abs/2606.21824)
*M. Renzo,O. Gottlieb,H. S. Chan,J. A. Goldberg,A. Grichener,K. Sen,N. Shah,E. Farag,Matteo Cantiello*
...
### [146] [Reverberation in the Narrow Fe K$α$ Line in the Seyfert Galaxy NGC 4151 with XRISM](https://arxiv.org/abs/2606.23384)
...
### [147] [Neutron Star Mass-Radius Constraints for EXO 0748$-$676 from 2008-2025 Quiescent X-ray Spectra](https://arxiv.org/abs/2606.23466)
...
### [148] [TeV-PeV Gamma-ray and Neutrino Emission in the Galactic Plane](https://arxiv.org/abs/2606.23476)
...
### [149] [A Tentative Double Excess in the Gamma-Ray Spectrum of the Fermi Blazar 4FGL J0604.9-0000](https://arxiv.org/abs/2606.23488)
*Shi-Ju Kang*
...
### [150] [Neutron Star Mass-Radius Constraints for EXO 0748$-$676 from 2008-2025 Quiescent X-ray Spectra](https://arxiv.org/abs/2606.23466)
*Mingyang Wang,Guobao Zhang,Ang Li*
...
### [151] [Spectral and timing variability of the transient ultraluminous X-ray source NGC 4631 X-4](https://arxiv.org/abs/2606.23498)
...
### [154] [Intraday Optical Variability of BL Lacertae during its Highly Active 2020-2024 Phase](https://arxiv.org/abs/2606.21936)
*A. Takey,Ergün Ege,B. M. Mihov,E. G. Elhosseiny,Aykut Ozdonmez,Murat Tekkesinoglu,Hüseyin Er,Aditi Agarwal,L. S. Slavcheva-Mihova,M. Emir Kenger,M. S. Rizk,I. Zead,F. I. Elnagahy,W. A. Badawy,S. K. J. Pacif*
...
### [155] [Multiwavelength variability of the high-energy neutrino candidate PKS 0735+178 over three decades](https://arxiv.org/abs/2606.22190)
*T. Mufakharov,Yu. Sotnikova,V. Vlasyuk,D. Kudryavtsev,A. Pushkarev,A. Mikhailov,M. Khabibullina,Yu. Kovalev,Y. Kovalev,A. Popkov,A. Erkenov,O. Spiridonova,T. Semenova,P. Tsybulev,D. Nezamov*
...
### [156] [Reverberation in the Narrow Fe K$α$ Line in the Seyfert Galaxy NGC 4151 with XRISM](https://arxiv.org/abs/2606.23384)
*Jon M. Miller,Aberahmen Zoghbi,Xin Xiang,Doyee Byun,Missagh Mehdipour,Liyi Gu,Ehud Behar,Laura Brenneman,Elisa Costantini,Luigi Gallo,Matteo Guainazzi,Peter Kosec,Takeo Minezaki,Stephane Paltani*
...
### [157] [WST -- Wide-field Spectroscopic Telescope: The Next Leap in Wide-field Spectroscopy](https://arxiv.org/abs/2606.20822)
...
### [158] [ReLaTS: a Reinforcement Learning-based method for dynamically determining the coupling Time Step in multi-scale simulations of self-gravitating systems](https://arxiv.org/abs/2606.20832)
...
### [159] [Ground control to major time-lag: on-sky results of data-driven predictive wavefront control at Keck Observatory](https://arxiv.org/abs/2606.20838)
...
### [160] [Classification of Eclipsing Binary Light Curves in Gaia DR3: A Machine Learning Approach](https://arxiv.org/abs/2606.21017)
...
### [161] [Quality Assessment of Spectroscopic Data Reduction Pipelines Using Artificial Intelligence: Scrutinizing Data Release 2 from the DESI Survey](https://arxiv.org/abs/2606.21035)
...
### [162] [Optimization and robustness of cost-efficient seismic arrays for Newtonian noise cancellation at the Einstein Telescope](https://arxiv.org/abs/2606.21110)
...
### [163] [High multiplex and precision: the design and development of FLEX, a grid-based fiber positioner with large patrol radius and minimized telecentric error](https://arxiv.org/abs/2606.21243)
...
### [164] [Development of TIFUUN: Terahertz Integral Field Units with Universal Nanotechnology](https://arxiv.org/abs/2606.21543)
...
### [165] [On-orbit Calibration of the Carruthers GCI: Instrument Effect Correction](https://arxiv.org/abs/2606.21606)
...
### [166] [Digital Beam Pattern Optimisation for the GRAO 32-m Telescope: A Comparative Analysis of FIR Filter Design Methods](https://arxiv.org/abs/2606.21720)
...
### [167] [Deep RL for Fast Long-Horizon Operations Scheduling on NASA's Carruthers Geocorona Observatory Mission](https://arxiv.org/abs/2606.22159)
...
### [168] [Distributed Peer Review at ALMA: An Empirical Comparison with Panel-Based Review](https://arxiv.org/abs/2606.22160)
...
### [169] [Reassessment of ammonia self- and air-broadened half-widths in the HITRAN database](https://arxiv.org/abs/2606.22267)
*Ali Elkhazraji*
...
### [170] [On-orbit Calibration of the Carruthers GCI: Radiometric Sensitivity](https://arxiv.org/abs/2606.22705)
...
### [171] [ffortissimo: A Freeform Forward-Modeling Pipeline for High-Contrast Images of Circumstellar Disks Based on Automatic Differentiation](https://arxiv.org/abs/2606.23478)
...
### [172] [Ground control to major time-lag: on-sky results of data-driven predictive wavefront control at Keck Observatory](https://arxiv.org/abs/2606.20838)
*Jules Fowler,Rebeca Jensen-Clem,Sylvain Cetre,Maaike A. M. van Kooten,Maissa Salama,Antonin Bouchez,Avinash Surendran,Charlotte Guthery,Eduardo Marin,Mahawa Cisse,Max Service,Charlotte Z. Bond,Emiel Por,Nour Skaf,Will Gauvin*
...
### [173] [On-orbit Calibration of the Carruthers GCI: Instrument Effect Correction](https://arxiv.org/abs/2606.21606)
*Alex Zhang,Heather Filippini,Lara Waldrop,Jason McPhate*
...
### [174] [Deep RL for Fast Long-Horizon Operations Scheduling on NASA's Carruthers Geocorona Observatory Mission](https://arxiv.org/abs/2606.22159)
*Alex Zhang,Jackson Craig,Lara Waldrop*
...
### [175] [Reassessment of ammonia self- and air-broadened half-widths in the HITRAN database](https://arxiv.org/abs/2606.22267)
*Ali Elkhazraji*
...
### [176] [On-orbit Calibration of the Carruthers GCI: Radiometric Sensitivity](https://arxiv.org/abs/2606.22705)
*Alex Zhang,Lara Waldrop,Heather Filippini,John Clarke,Pratik Joshi,Gonzalo Cucho-Padin,Parisa Karimi,Martin M. Sirk*
...
### [177] [On-orbit Calibration of the Carruthers GCI: Radiometric Sensitivity](https://arxiv.org/abs/2606.22705)
*Alex Zhang,Lara Waldrop,Heather Filippini,John Clarke,Pratik Joshi,Gonzalo Cucho-Padin,Parisa Karimi,Martin M. Sirk*
...
### [178] [ffortissimo: A Freeform Forward-Modeling Pipeline for High-Contrast Images of Circumstellar Disks Based on Automatic Differentiation](https://arxiv.org/abs/2606.23478)
*Jay K. Kueny,Joseph D. Long,Jared R. Males,Alycia J. Weinberger,Laird M. Close,Joshua Liberman,Sebastiaan Haffert,Eden McEwen,Maggie Y. Kautz,Olivier Guyon,Logan Pearce,Parker T. Johnson,Katie Twitchell,Jialin Li,Alex Hedglen,Avalon Gower,Warren Foster,Jhen Lumbres,Lauren Schatz*
...
### [179] [Radio Spectral Imaging and MHD Modeling of a CME-Driven Shock: Connecting Solar Type II Radio Bursts with Shock-Surface Magnetic Geometry](https://arxiv.org/abs/2606.20854)
...
### [180] [Two stages of magnetic filament formation in the solar convective zone](https://arxiv.org/abs/2606.20992)
...
### [181] [XP-TEAL: Gaia XP Tool for Emission and Absorption Lines II. Gaia-HELIX catalogue of H$α$ emitters in Gaia BP/RP spectra](https://arxiv.org/abs/2606.21420)
...
### [182] [Transonic Solutions for Recombination-Driven Stellar Winds](https://arxiv.org/abs/2606.21624)
...
### [183] [On the stellar parameter dependence of the combined Fe I and Fe II chromospheric emission-line in the wings of the Ca II K line](https://arxiv.org/abs/2606.21808)
...
### [184] [The efficiency per free-fall time as a ratio of the Star Formation Rate to the gas-infall rate in collapsing cores: dependence on the core definition, accretion, and radial structure](https://arxiv.org/abs/2606.21878)
...
### [185] [Prediction of Solar Flares Using Photospheric Magnetic Field Parameters with Deep Learning](https://arxiv.org/abs/2606.21896)
...
### [186] [Effect of surface magnetic fields on limb darkening in main-sequence stars](https://arxiv.org/abs/2606.21912)
...
### [187] [FAUST XXXI. Grain properties and variability of three sources in GSS 30](https://arxiv.org/abs/2606.22489)
...
### [188] [Comparative Study of Two Luminous Red Novae I. Progenitor Modeling and Dust Formation](https://arxiv.org/abs/2606.22619)
...
### [189] [Surface brightness-color relations for red giant branch stars: Observational constraints on metallicity effects using the ARD method](https://arxiv.org/abs/2606.22818)
...
### [190] [X-shooter spectroscopy of giant stars in the nuclear star cluster](https://arxiv.org/abs/2606.22893)
...
### [191] [Influence of mass transfer stability on the formation of post-common-envelope binaries](https://arxiv.org/abs/2606.22927)
...
### [192] [Detection of actinides in CEMP-rs stars](https://arxiv.org/abs/2606.23388)
...
### [193] [A $λ=1.3$ millimeter Survey for Disks around Herbig Be Stars](https://arxiv.org/abs/2606.23393)
...
### [194] [New assignments of the CaH $A^{2}Π-X^{2}Σ^{+}$ transitions in the sunspot umbral spectrum and effective temperature estimation using molecular lines](https://arxiv.org/abs/2606.23421)
...
### [195] [Phase-space averaging for stellar convection I. Liouvillian dynamics](https://arxiv.org/abs/2606.23424)
...
### [196] [Phase-space averaging for stellar convection II. Maximum-entropy closures for mixed radiative-convective envelopes](https://arxiv.org/abs/2606.23429)
*P. S. Houdayer,M. Rieutord*
...
### [197] [XP-TEAL: Gaia XP Tool for Emission and Absorption Lines II. Gaia-HELIX catalogue of H$α$ emitters in Gaia BP/RP spectra](https://arxiv.org/abs/2606.21420)
*S. Malhotra,M. Weiler,F. Anders,J. M. Carrasco,G. Garcia-Moreno,C. Jordi,N. Blagorodnova,A. Castro-Ginard,J. Castañeda,F. Boix,X. Luri*
...
### [198] [Stellar winds of O-type stars traced by high ionization fine-structure emission lines with JWST/MIRI](https://arxiv.org/abs/2606.23456)
...
### [199] [Phase-mixing of acoustic waves with applications to solar tachocline](https://arxiv.org/abs/2606.23460)
*D. Tsiklauri*
...
### [200] [Time-domain anomalies in solar and stellar flares](https://arxiv.org/abs/2606.23482)
...
### [201] [Corotating Interaction Regions (CIRs): evolution over a solar lifetime](https://arxiv.org/abs/2606.23576)
...
### [202] [New assignments of the CaH $A^{2}Π-X^{2}Σ^{+}$ transitions in the sunspot umbral spectrum and effective temperature estimation using molecular lines](https://arxiv.org/abs/2606.23421)
*Kosei Usami,Kaori Kobayashi,Hiroyuki Maehara*
...
### [203] [FAUST XXXI. Grain properties and variability of three sources in GSS 30](https://arxiv.org/abs/2606.22489)
*Q. Yang,H. Baobab Liu,S. Feng,C. J. Chandler,F. Fontani,N. Sakai,Y. Oya,T. Hanawa,C. Codella,C. Ceccarelli,I. Jiménez-Serra,L. Cacciapuoti,E. Bianchi,M. Bouvier,M. De Simone,A. Isella,D. Johnstone,L. Loinard,G. Sabatini,Y. Shirley,Y. Aikawa,M. J. Maureira,P. Caselli,F. Menard,N. Balucani,E. Caux,S. Charnley,N. Cuello,F. Dulieu,L. Evans,D. Fedele,T. Hama,E. Herbst,T. Hirota,B. Lefloch,A. López-Sepulcre,L. T. Maud,A. Miotello,G. Moellenbrock,H. Nomura,Y. Oba,S. Ohashi,Y. Okoda,J. Pineda,L. Podio,A. Rimola,T. Sakai,D. Segura-Cox,B. Svoboda,L. Testi,C. Vastel,S. Viti,N. Watanabe,Y. Watanabe,Y. Zhang,Z. E. Zhang,F. O. Alves,S. Yamamoto*
...
### [204] [A $λ=1.3$ millimeter Survey for Disks around Herbig Be Stars](https://arxiv.org/abs/2606.23393)
*David J. Wilner,Joshua Bennett Lovell,Sean M. Andrews,Miguel Vioque,Feng Long,Luca Matra*
...
### [205] [New assignments of the CaH $A^{2}Π-X^{2}Σ^{+}$ transitions in the sunspot umbral spectrum and effective temperature estimation using molecular lines](https://arxiv.org/abs/2606.23421)
*Kosei Usami,Kaori Kobayashi,Hiroyuki Maehara*
...
### [206] [Comparative Study of Two Luminous Red Novae I. Progenitor Modeling and Dust Formation](https://arxiv.org/abs/2606.22619)
*M. Wavasseur,N. Blagorodnova,M. A. Gómez-Muñoz,O. R. Pols*
...
### [207] [XP-TEAL: Gaia XP Tool for Emission and Absorption Lines II. Gaia-HELIX catalogue of H$α$ emitters in Gaia BP/RP spectra](https://arxiv.org/abs/2606.21420)
*S. Malhotra,M. Weiler,F. Anders,J. M. Carrasco,G. Garcia-Moreno,C. Jordi,N. Blagorodnova,A. Castro-Ginard,J. Castañeda,F. Boix,X. Luri*
...
### [208] [FAUST XXXI. Grain properties and variability of three sources in GSS 30](https://arxiv.org/abs/2606.22489)
*Q. Yang,H. Baobab Liu,S. Feng,C. J. Chandler,F. Fontani,N. Sakai,Y. Oya,T. Hanawa,C. Codella,C. Ceccarelli,I. Jiménez-Serra,L. Cacciapuoti,E. Bianchi,M. Bouvier,M. De Simone,A. Isella,D. Johnstone,L. Loinard,G. Sabatini,Y. Shirley,Y. Aikawa,M. J. Maureira,P. Caselli,F. Menard,N. Balucani,E. Caux,S. Charnley,N. Cuello,F. Dulieu,L. Evans,D. Fedele,T. Hama,E. Herbst,T. Hirota,B. Lefloch,A. López-Sepulcre,L. T. Maud,A. Miotello,G. Moellenbrock,H. Nomura,Y. Oba,S. Ohashi,Y. Okoda,J. Pineda,L. Podio,A. Rimola,T. Sakai,D. Segura-Cox,B. Svoboda,L. Testi,C. Vastel,S. Viti,N. Watanabe,Y. Watanabe,Y. Zhang,Z. E. Zhang,F. O. Alves,S. Yamamoto*
...
### [209] [Comparative Study of Two Luminous Red Novae I. Progenitor Modeling and Dust Formation](https://arxiv.org/abs/2606.22619)
*M. Wavasseur,N. Blagorodnova,M. A. Gómez-Muñoz,O. R. Pols*
...
### [210] [Stellar winds of O-type stars traced by high ionization fine-structure emission lines with JWST/MIRI](https://arxiv.org/abs/2606.23456)
*Calum Hawcroft,David R. Law,Linda J. Smith,Alexander W. Fullerton,Karl D. Gordon,Paul A. Crowther,Marjorie Decleir,Sascha T. Zeegers,Christiana Erba,Richard Ignace,D. John Hillier*
